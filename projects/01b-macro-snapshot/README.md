...
Tier 2 packs add storage and multi-step pipelines. Same pattern, more surface: deterministic logic first, the model only for the judgement call, every external reach declared in the Policy Card.
